...
def make_changes(cursor, folder_path, file_map, script_file, need_flush):
...
if __name__ == '__main__':
    ...
    script_path = os.path.join(folder_path, f"{file_name}.sql")
    ...
    try:
        ...
        with open(script_path, "w", encoding="utf-8") as script_file:
            ...
            make_changes(cursor, folder_path, file_map, script_file, need_flush)
            script_file.write("COMMIT;\n")
        if need_flush:
            connection.commit()
            print("Done. All changes committed.")
        else:
            print("Done. SQL script generated without database execution.")
